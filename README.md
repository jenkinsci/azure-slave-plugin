...
#The Azure Slave plugin is deprecated in favor of the [Azure VM Agents](https://aka.ms/AzJenkinsMigrateToAgents) plugin ([GitHub]( https://github.com/jenkinsci/azure-vm-agents-plugin)).
